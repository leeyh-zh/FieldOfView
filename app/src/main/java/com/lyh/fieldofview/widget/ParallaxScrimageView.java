...
import com.lyh.fieldofview.utils.ColorUtils;
...
public class ParallaxScrimageView extends ImageView {
    ...
    public ParallaxScrimageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ParallaxScrimageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
